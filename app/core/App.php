    ...
    public function startRoute()
    {
        foreach (self::$routes as $routes) {
            ...
            if ($methodCheck && $pathCheck) {
                ...
                if (file_exists($file = DIRECTORY . "/modules/{$module}/controller/{$controller}.php")) {
                    require_once $file;
